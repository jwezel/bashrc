if type -p lsd > /dev/null; then
 ...
 alias tl="lsd --tree --group-directories-first --date '+%F %T'"
 alias tll="lsd --tree --group-directories-first --long --date '+%F %T'"
 alias tla="lsd --tree --group-directories-first --all --date '+%F %T'"
 alias tlla="lsd --tree --group-directories-first --long --all --date '+%F %T'"
 alias tlld="lsd --tree --group-directories-first --long --directory-only --date '+%F %T'"
 alias tllda="lsd --tree --group-directories-first --long --all --directory-only --date '+%F %T'"
 alias tllad="lsd --tree --group-directories-first --long --all --directory-only --date '+%F %T'"
 alias tllt="lsd --tree --group-directories-first --long --sort time --date '+%F %T'"
 alias tllat="lsd --tree --group-directories-first --long --all --sort time --date '+%F %T'"
 alias tllta="lsd --tree --group-directories-first --long --all --sort time --date '+%F %T'"
